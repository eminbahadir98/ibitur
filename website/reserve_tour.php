...
<body class="content">
    ...
    <?php
            ...
            if($get_dependent_result->num_rows == 0) {
                ...
                echo "<form name='done-reservation' action='make_reservation.php?id=$tour_id' method='post' >";
                ...
                echo "<input class='submit-button btn' type='submit' name='reserve-submit' value='Reserve Without Payment'/>";
